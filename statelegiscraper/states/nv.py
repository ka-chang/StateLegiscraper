...
StateLegiscraper has two classes for each state module: Scrape and Process
    ...
    NVScrape includes 1 function that scrapes PDF transcripts present at a list of weblinks
    This class provides user with raw data saved on a local or mounted drive

    NVProcess includes 3 functions that processes raw data (PDF Transcripts)
